...
class dielectric: public material {
  public:
    ...
    bool scatter(const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered)
    const override {
        // if ray hitting from front face, then ray gets refracted from air to object (1.0/refractive_index)
        // else then ray is refracted from object to air (refractive_index)
